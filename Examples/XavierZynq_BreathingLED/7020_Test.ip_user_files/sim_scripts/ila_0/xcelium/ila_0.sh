...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../7020_Test.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../7020_Test.gen/sources_1/ip/ila_0/hdl/verilog" \
