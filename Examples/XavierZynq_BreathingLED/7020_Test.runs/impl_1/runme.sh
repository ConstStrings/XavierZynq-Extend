...
HD_PWD='E:/ProgramData/Xilinx/7020_Test/7020_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_pwm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_pwm.tcl -notrace
